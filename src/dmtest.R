...
# These should all be equal btw, to ensure we all used the same OOS periods (i've already checked 1m beforehand)
...
model_names <- c("AR", "Targeted PCR", "XGBoost", "Random Forest", "Ridge")
